...
document.getElementById('copyAnswer').addEventListener('click', () => {
    navigator.clipboard.writeText(answerTextarea.value).catch(err => alert('Failed to copy'));
});

document.getElementById('pasteOffer').addEventListener('click', async () => {
    try {
        offerTextarea.value = await navigator.clipboard.readText();
    } catch (err) {
...
async function generateAnswer() {
    ...
    localConnection.ondatachannel = (event) => {
        ...
        receiveChannel.onopen = () => {
            ...
            document.getElementById("pasteOffer").style.display = 'none';
            document.getElementById("copyAnswer").style.display = 'none';
            document.getElementById("generateAnswer").style.display = 'none';
        };
