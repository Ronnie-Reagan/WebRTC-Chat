...
async function startHost() {
    ...
    sendChannel.onopen = () => {
        ...
        document.getElementById("pasteAnswer").style.display = 'none';
        document.getElementById("copyOffer").style.display = 'none';
        document.getElementById("acceptAnswerBtn").style.display = 'none';
...
document.getElementById('startHostBtn').addEventListener('click', startHost);
